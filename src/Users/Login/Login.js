        ...
        <div className="bg-white bg-base-300    rounded-lg  sm:w-full lg:w-[500px] p-6">
          ...
          >
            ...
            <p className="text-left mb-3">
              {" "}
              {errors?.email && (
                <span className=" text-red-600 text-left capitalize ">
                  email is required
                </span>
              )}
            </p>
            ...
            <input
              type="password"
              className="  mt-5 block border border-grey-light w-full p-3 rounded "
              name="password"
            ...
            <button
              type="submit"
              className="btn-wide btn text-xl capitalize text-center  rounded bg-black text-white hover:bg-green-dark focus:outline-none my-1 block m-auto"
            >
              login
            </button>
